                ...
                <div class="p-6 lg:p-8">
                    ...
                    <form method="POST" action="{{ route('instructors.store') }}" class="space-y-6">
                        ...
                        <div class="flex items-center justify-end space-x-4 pt-6 border-t border-gray-200">
                            <a href="{{ route('instructors.index') }}"
                               class="px-5 py-2 border border-red-500 rounded-md text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                Cancelar
                            </a>
